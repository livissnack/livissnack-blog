...
需求：支持手动配置（Shadowsocks、VMess、Trojan）节点
...
```yaml
 - DOMAIN-SUFFIX,www.maomei.com,DIRECT
 - DOMAIN-SUFFIX,www.umeng.com,DIRECT
 - DOMAIN-SUFFIX,developer.umeng.com,DIRECT
 - DOMAIN-SUFFIX,homestead.test,DIRECT
 - DOMAIN-SUFFIX,laravel9.test,DIRECT
 - DOMAIN-SUFFIX,lumen8.test,DIRECT
 - DOMAIN-SUFFIX,www.parse.com,DIRECT
 - DOMAIN-SUFFIX,admin.doniai.com,DIRECT
 - DOMAIN-SUFFIX,activate.navicat.com,DIRECT
 - DOMAIN-SUFFIX,hiphup_app.test,DIRECT
 - DOMAIN-SUFFIX,moi_mz.test,DIRECT
 - DOMAIN-SUFFIX,my_mz.test,DIRECT
 - DOMAIN-SUFFIX,laravel.test,DIRECT
```
